...
<body>
  <div class="container col-md-12 col-lg-12 align-items-center">
        ...
        <main role="main" class="col-md-12   col-lg-12 pt-3 px-4 ">
          ...
          <canvas class="my-4" id="myChart" style=" width:200px; height:80px; "></canvas>

          
          <div class="row col-12">
                <div class="card col-md-12 col-sm-12 col-lg-6" style="padding:10px;margin:10px">
                    <h2 class="col-12">Productos mas vendidos</h2>
              ...
              <div class="card col-md-12 col-lg-5 col-sm-12" style="padding:10px; margin:10px">
                  ...
                  <div class="comment-widgets scrollable">
                      ...
                      <div id="colorcito" class="d-flex flex-row comment-row" style="text-align:left">
                          <div class="p-4 col-2"><img src="img/user.webp" alt="user" width="50" class="rounded-circle"></div>
